...
(function() {
  ...
  CelestialBody.Ike = Ike = new CelestialBody(3.88794E+20, 210000, 955507.445592476, new Orbit(Duna, 36680000, 0.03, 0.2, 90, 345, 180));
  ...
  CelestialBody.Laythe = Laythe = new CelestialBody(1.0312E+23, 1100000, 115299.753436233, new Orbit(Jool, 87640000, 0.01, 0.2, 120, 120, 180));
  CelestialBody.Vall = Vall = new CelestialBody(8.00068E+21, 550000, 285030.00096071, new Orbit(Jool, 160230000, 0.03, 0.3, 90, 270, 180));
  CelestialBody.Tylo = Tylo = new CelestialBody(3.80859E+22, 900000, 704636.407486379, new Orbit(Jool, 292950000, 0.01, 0.1, 150, 285, 270));
  CelestialBody.Bop = Bop = new CelestialBody(2.6522E+20, 190000, 1978081.28781907, new Orbit(Jool, 582970000, 0.235, 15, 10, 25, 270));
  ...
  CelestialBody.Aden = Aden = new CelestialBody(9.25699E+20, 300000, 286875.24899704, new Orbit(Lindor, 107140000, 0.01, 0.25, 120, 30, 270));
  CelestialBody.Huygen = Huygen = new CelestialBody(9.89396E+21, 670000, 664152.061283006, new Orbit(Lindor, 187500000, 0.025, 0.75, 150, 60, 90));
  CelestialBody.Riga = Riga = new CelestialBody(1.48773E+22, 750000, 1407680.09452737, new Orbit(Lindor, 309380000, 0.03, 0.5, 90, 105, 180));
  CelestialBody.Talos = Talos = new CelestialBody(4.04075E+21, 500000, 3573035.48442024, new Orbit(Lindor, 575680000, 0.04, 1, 180, 285, 90));
  CelestialBody.Eeloo = Eeloo = new CelestialBody(7.93456E+21, 600000, 14400, new Orbit(Sun, 471171300000, 0.26, 6.15, 50, 260, 3.54));
  CelestialBody.Celes = Celes = new CelestialBody(2.35098E+20, 200000, 1548329.29408971, new Orbit(Eeloo, 31800000, 0.05, 10, 100, 270, 0));
  ...
  CelestialBody.Amos = Amos = new CelestialBody(9.02777E+20, 320000, 232809.997387739, new Orbit(Nara, 55880000, 0.01, 0.5, 180, 345, 180));
  CelestialBody.Enon = Enon = new CelestialBody(1.07998E+22, 700000, 788078.420847453, new Orbit(Nara, 125980000, 0.015, 0.2, 270, 0, 180));
  CelestialBody.Prax = Prax = new CelestialBody(35558600000000000000, 110000, 21600, new Orbit(Nara, 751900000, 0.4, 17, 95, 100, 0));
  CelestialBody.Grannus = Grannus = new CelestialBody(5.96840268332872E+28, 75425000, 2592000, new Orbit(Sun, 5000000000000, 0.1, 7, 195, 20, -0.426));
