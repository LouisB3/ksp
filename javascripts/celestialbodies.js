...
(function() {
  var CelestialBody, HALF_PI, TWO_PI, G, Sun, Moho, Eve, Gilly, Kerbin, Mun, Minmus, Duna, Ike, Edna, Dak, Dres, Jool, Laythe, Vall, Tylo, Bop, Pol, Lindor, Krel, Aden, Huygen, Riga, Talos, Eeloo, Celes, Tam, Hamek, Nara, Amos, Enon, Prax;
  ...
  CelestialBody.Ike = Ike = new CelestialBody(3.88794e20, 210000, 955497.6, new Orbit(Duna, 36680000, 0.03, 0.2, 90, 345, 180));
  ...
  CelestialBody.Laythe = Laythe = new CelestialBody(1.0312e23, 1100000, 115300.8, new Orbit(Jool, 87640000, 0.01, 0.2, 120, 120, 180));
  CelestialBody.Vall = Vall = new CelestialBody(8.00068e21, 550000, 285029.28, new Orbit(Jool, 160230000, 0.03, 0.3, 90, 270, 180));
  CelestialBody.Tylo = Tylo = new CelestialBody(3.80859e22, 900000, 704635.2, new Orbit(Jool, 292950000, 0.01, 0.1, 150, 285, 270));
  CelestialBody.Bop = Bop = new CelestialBody(2.6522e20, 190000, 1978084.8, new Orbit(Jool, 582970000, 0.235, 15, 10, 25, 270));
  ...
  CelestialBody.Aden = Aden = new CelestialBody(9.25699e20, 300000, 286873.92, new Orbit(Lindor, 107140000, 0.01, 0.25, 120, 30, 270));
  CelestialBody.Huygen = Huygen = new CelestialBody(9.89396e21, 670000, 664156.8, new Orbit(Lindor, 187500000, 0.025, 0.75, 150, 60, 90));
  CelestialBody.Riga = Riga = new CelestialBody(1.48773e22, 750000, 1407672, new Orbit(Lindor, 309380000, 0.03, 0.5, 90, 105, 180));
  CelestialBody.Talos = Talos = new CelestialBody(4.04075e21, 500000, 3573028.8, new Orbit(Lindor, 575680000, 0.04, 1, 180, 285, 90));
  CelestialBody.Eeloo = Eeloo = new CelestialBody(7.93456e21, 600000, 14400, new Orbit(Sun, 471171300000, 0.26, 6.15, 50, 260, 3.54));
  CelestialBody.Celes = Celes = new CelestialBody(2.35098e20, 200000, 1548331.2, new Orbit(Eeloo, 31800000, 0.05, 10, 100, 270, 0));
  ...
  CelestialBody.Amos = Amos = new CelestialBody(9.02777e20, 320000, 232809.12, new Orbit(Nara, 55880000, 0.01, 0.5, 180, 345, 180));
  CelestialBody.Enon = Enon = new CelestialBody(1.07998e22, 700000, 788097.6, new Orbit(Nara, 125980000, 0.015, 0.2, 270, 0, 180));
