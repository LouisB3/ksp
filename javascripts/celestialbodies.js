...
(function() {
  ...
  //CelestialBody.Belisama = Belisama = new CelestialBody(1.54971938782199e22, 625000, 307440.000000024, new Orbit(Nodens, 42925644.1946, 0.025, 9.5, 135, 165, 4.875));
  ...
  CelestialBody.Airmed = Airmed = new CelestialBody(3.52647256251049e21, 400000, 218962.804389807, new Orbit(Sirona, 87500000, 0.01, 1, 120, 90, 0));
  CelestialBody.Brovo = Brovo = new CelestialBody(2.89280952393438e22, 750000, 619320.335246624, new Orbit(Sirona, 175000000, 0.02, 0.5, 150, 30, 3.141592654));
  CelestialBody.Damona = Damona = new CelestialBody(3.52647256251049e20, 200000, 1390081.13421702, new Orbit(Sirona, 300000000, 0.05, 4, 210, 300, 0));
  ...
  CelestialBody.RAB58E = RAB58E = new CelestialBody(826517006838396000, 25000, 14400, new Orbit(Epona, 225000000, 0.4, -160, 225, 180, 0));
